  ...
  return (
    <footer className="bg-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center mb-4">
              <img src={logo} alt="HZ2 Bâtiment Logo" className="h-10 filter brightness-0 invert" />
            </Link>
            <p className="text-gray-400 mb-4">
              HZ2 Bâtiment, votre partenaire de confiance pour tous vos projets de construction et rénovation depuis 2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">0661 54 16 45 / 0661 91 49 87</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">hz2batiment.travaux.info@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="bg-gray-950 py-4">
        <div className="container-custom px-4 flex flex-col md:flex-row justify-between items-center">
